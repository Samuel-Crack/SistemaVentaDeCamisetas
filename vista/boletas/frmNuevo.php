...
<body>
    ...
    <form action="?ctrl=CtrlBoletas&accion=guardarNuevo" method="post">
        ...
        <div class="col-md-6">
            <label for="inputboletas" class="form-label">Id Clientes:</label>
            <input type="text" class="form-control"
                name="idclientes" value="" id="inputboletas">
        </div>
        <div class="col-md-6">
            <label for="inputboletas" class="form-label">Id Vendedor:</label>
            <input type="text" class="form-control"
                name="idvendedor" value="" id="inputboletas">
        </div>
        </div>
        <div class="col-md-3">
